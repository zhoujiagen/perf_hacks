...
import static tamp.ch16.Steal.steal.PolynomialTask.Polynomial;
...
public class PolynomialTaskTest extends TestCase {
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(tamp.ch14.Steal.steal.PolynomialTaskTest.class);
    ...
    public void testRun() throws InterruptedException, ExecutionException {
        ...
        Polynomial bb = new Polynomial(b, 0, b.length);
